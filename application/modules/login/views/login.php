...
<body>
     <!-- Akhir Login -->
     <div class="hold-transition login-page"><br />
          <div class="login-box"><br />
               <div class="login-logo">
                    <div class="header" style="font-size: 13px;text-align:center;margin-top:8px">
                         <center><a href="#"><img src="<?php echo base_url('assets/img/logotlc2.png') ?>"
                                        style="margin-bottom:10px" class="img-fluid" width="100" /></a><br />
                                   ...
                                   <div class="col-md-12">
                                        <section class="widget widget-login bg-transparent animated fadeInUp">
                                             <div class="widget-body"></br>
                                                  <b>
                                                       <p class="widget-login-info"
                                                            style="font-size:20px;text-align:center;margin-top:8px;color: black">
                                                            LOGIN
                                                       </p>
                                                  </b>
                                                  ...
                                                  <input type="checkbox" class="offset-sm-0" id="show-password">
                                                  Tampilkan
                                                  Password
                                             ...
                                             <div class="clearfix">
                                                  ...
                                                  <div class="" style="font-size: 13px;" align="center"> Hubungi
                                                       Administrator<br>untuk registrasi akun / lupa password</div>
                                             </div>
                                   </div>
