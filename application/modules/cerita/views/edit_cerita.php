    ...
    <body id="body-pd">
        ...
        <div class="card col-sm-12">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url('cerita/fungsiEdit') ?>" method="post">

                    <input type="hidden" name="id_cerita" value="<?php echo $queryCrtDetail->id_cerita ?>">
                    <div class="form-group">
                        <td><b>Nama Lengkap</b></td>
                        <td><input type="text" name="nama_lengkap" class="form-control"
                                value="<?php echo $queryCrtDetail->nama_lengkap ?>"></input></td>
                        <br />
                    </div>

                    <div class="form-group">
                        <td><b>Isi Berita</b></td>
                        <td><input type="text" name="isi_cerita" class="form-control"
                                value="<?php echo $queryCrtDetail->isi_cerita ?>"></input></td>
                        <br />
                    </div>

                    <div class="form-group">
                        <td><b>Tanggal Cerita</b></td>
                        <td><input type="text" name="tgl_cerita" class="form-control"
                                value="<?php echo $queryCrtDetail->tgl_cerita ?>"></input></td>
                        <br />
                    </div>

                    <div class="main">
                        <button id="flash" colspan="3" type="submit" class="btn bg-secondary text-white" name=" btambah"
                            onclick="sweetAlert()">Update Cerita</button></a>
                    </div>
