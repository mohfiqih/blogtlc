...
<body oncontextmenu='return false' class='snippet-body'>
    ...
    <body id="body-pd">
        ...
        <div class="card col-sm-12">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('cerita/fungsiTambah') ?>" method="post">
                    <div class="form-group">
                        <td><b>Nama Lengkap</b></td>
                        <td><input type="text" name="nama_lengkap" class="form-control"
                                placeholder="Masukkan Nama Lengkap" required></input></td>
                        <br />
                    </div>

                    <div class="form-group">
                        <td><b>Isi Cerita</b></td>
                        <td><input type="text" name="isi_cerita" class="form-control" placeholder="Masukkan Isi Cerita"
                                required></input></td>
                        <br />
                    </div>
                    ...
                    <div class="form-group">
                        <td><b>Tanggal</b></td>
                        <td><input type="text" name="tgl_cerita" class="form-control" placeholder="Format: 16-08-2021"
                                required></input></td>
                        <br />
                    </div>
                    ...
                    <div class="main">
                        <button id="flash" colspan="3" type="submit" class="btn bg-secondary text-white" name=" btambah"
                            onclick="sweetAlert()">Unggah Cerita</button></a>
                    </div>
                </form>
            </div>
        </div><br />
            ...
            <div class="card-body" style="overflow: auto;">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $row->isi_cerita ?>
                        </td>
                        <td>
                            <?php echo $row->tgl_cerita ?>
                        </td>
                        <td>
                            <a class="btn bg-warning icon-dark"
                                href="<?php echo base_url('cerita/edit_cerita') ?>/<?php echo $row->id_cerita ?>"> <i
                                    class="
                                fa fa-edit"></a></i>
                        </td>
                        <td>
                            <a class="btn bg-danger text-white"
                                href="<?php echo base_url('cerita/fungsiDelete') ?>/<?php echo $row->id_cerita ?>"><i
                ...
                <b>
                    <label>Jumlah Cerita : </b> <?php echo $jml_cerita?></label>
                </b>
