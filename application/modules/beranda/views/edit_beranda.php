        ...
        <div class="height-100"><br />
            ...
            <div class="card col-sm-12">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('beranda/fungsiEdit'); ?>
                    <input type="hidden" name="id" value="<?php echo $queryBrdDetail->id ?>">
                    <div class="form-group">
                        <label><b>Upload Foto Konten</b></label><br />
                        <input type="file" name="foto" class="form-control"
                            value="<?php echo $queryBrdDetail->foto ?>"></input>
                        <br />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <td><input type="text" name="judul" class="form-control"
                                value="<?php echo $queryBrdDetail->judul ?>"></input></td>
                        <br />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <td><input type="text" name="isi" class="form-control"
                                value="<?php echo $queryBrdDetail->isi ?>"></input></td>
                        <br />
                    </div>

                    <div class="form-group">
                        <td><b>More Info</b></td>
                        <td><input type="text" name="more" class="form-control"
                                value="<?php echo $queryBrdDetail->more ?>"></input></td>
                        <br />
                    </div>

                    <div class="main">
                        <button id="flash" colspan="3" type="submit" class="btn bg-warning text-black" name="btambah"
                            onclick="sweetAlert()">Update Konten</button></a>

                        <a class="btn btn-success" href=" <?php echo base_url('beranda/admin') ?>">Kembali</a>
                    </div>
